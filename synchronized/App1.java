public class App1{
    ...
    public static void main(String args[]){
        ...
        Consumidor consumidor3 = new Consumidor(deposito, 4);
        ...
        Thread produtor4 = new Thread(new Produtor(deposito, 5));
        Thread produtor5 = new Thread(new Produtor(deposito, 2));
